        ...
        <div className="flex items-center justify-between">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <Link to="/" className="block hover-glow">
              <img 
                src="/lovable-uploads/82fae56d-d6d7-4852-a667-9865548a6af5.png" 
                alt="Summit Seekers" 
                className="w-16 h-16 md:w-20 md:h-20 rounded-full neon-glow transition-all duration-300"
              />
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link 
              to="/" 
              className={`text-lg font-medium transition-all duration-300 hover:text-primary hover-glow relative group ${
                location.pathname === '/' ? 'neon-text' : 'text-foreground'
              }`}
            >
              Home
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link 
              to="/contact" 
              className={`text-lg font-medium transition-all duration-300 hover:text-primary hover-glow relative group ${
                location.pathname === '/contact' ? 'neon-text' : 'text-foreground'
              }`}
            >
              Contact
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-full"></span>
          ...
          <div className={`absolute top-2 right-4 transition-all duration-500 ${
            isScrolled ? 'opacity-100 transform scale-100' : 'opacity-0 transform scale-0'
          }`}>
            <img 
              src="/lovable-uploads/82fae56d-d6d7-4852-a667-9865548a6af5.png" 
              alt="Summit Seekers" 
